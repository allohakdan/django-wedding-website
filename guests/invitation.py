...
INVITATION_TEMPLATE = 'guests/email_templates/invite.html'
...
def get_invitation_context(party):
    return {
        'title': "WEDDING O'CLOCK",
        'main_image': 'FullPoster.png',
        'main_color': '#fff3e8',
        'font_color': '#666666',
        'page_title': "Vicki and Dan - You're Invited!",
...
def send_invitation_email(party, test_only=False, recipients=None):
    ...
    msg.attach_alternative(template_html, "text/html") #TODO - hook up email html
